SE_L = [
            ...
            ['Lost Love (Part 1)', 'Lost Love (Part 2)', 'Back from the Dead', 'Ghost Ship', 'Fire and Ice', 'GX-1', 'Jack in the Box', 'The Widowmaker', 'Hell Week', 'Blow Out', 'Kill Zone', 'Early Retirement', 'Thin Ice', 'The Odd Triple', 'The Negotiator', 'The Spoilers', 'Mask of the Wolf', 'Rock the Cradle', 'The Endangered', "Murderers' Sky"],
            ...
            ['Legend of the Holy Rose (Part 1)', 'Legend of the Holy Rose (Part 2)', 'The Black Corsage', 'Cease Fire', 'Second Chance', 'Halloween Knights', 'Children of Light', 'Black Rhino', 'The Ten Percent Solution', 'Two Times Trouble', 'The Madonna', 'Serenity', 'Live and Learn', 'Log Jam', 'The Treasure of Manco', "Jenny's Chance", 'Deep Cover', 'The Lost Amadeus', 'Hearts of Steel', 'Rush to Judgement', 'Passages'],
            ['Tough Boys', 'Humanity', 'The Gun', 'Twenty Questions', 'The Wall', 'Lesson in Evil', "Harry's Will", "MacGyver's Women", 'Bitter Harvest', 'The Visitor', 'Squeeze Play', 'Jerico Games', 'The Wasteland', 'Eye of Osiris', 'High Control', 'There But For the Grace', 'Blind Faith', 'Faith, Hope & Charity', 'Strictly Business', 'Trail of Tears', 'Hind-Sight'],
            ['Honest Abe', "The 'Hood", 'Obsessed', 'The Prometheus Syndrome', 'The Coltons', 'Walking Dead', 'Good Knight MacGyver (Part 1)', 'Good Knight MacGyver (Part 2)', 'Deadly Silents', 'Split Decision', "Gunz 'N Boyz", 'Off the Wall', 'The Stringer', 'The Mountain of Youth']
]
...
if __name__ == '__main__':
    for s_num, s in enumerate(SE_L):
        print('season ', s_num + 1, ': # episodes:  ', len(s))